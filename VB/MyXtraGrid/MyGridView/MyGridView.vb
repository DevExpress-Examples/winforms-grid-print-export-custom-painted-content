...
Namespace MyXtraGrid
    ...
    Public Class MyGridView
        ...
        Public Function GetCustomDrawCellArgs(ByVal cache As GraphicsCache, ByVal rect As Rectangle, ByVal col As GridColumn) As FooterCellCustomDrawEventArgs
            Dim styleArgs As GridFooterCellInfoArgs = New GridFooterCellInfoArgs(cache)
            styleArgs.Bounds = New Rectangle(New Point(0, 0), rect.Size)
            Dim args As FooterCellCustomDrawEventArgs = New FooterCellCustomDrawEventArgs(cache, -1, col, Nothing, styleArgs)
            args.Handled = True
        ...
        Public Function GetCustomDrawRowIndicatorArgs(ByVal cache As GraphicsCache, ByVal rect As Rectangle) As RowIndicatorCustomDrawEventArgs
            Dim styleArgs As IndicatorObjectInfoArgs = New IndicatorObjectInfoArgs(cache)
            styleArgs.Bounds = New Rectangle(New Point(0, 0), rect.Size)
            Dim args As RowIndicatorCustomDrawEventArgs = New RowIndicatorCustomDrawEventArgs(cache, -1, Nothing, styleArgs)
            args.Handled = True
